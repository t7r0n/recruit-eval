...
COMPANY = 'Outbound Agent Eval'
REPO = 'outbound-agent-eval'
...
PROJECT_DIRECTION = 'A local evaluation and replay harness for recruiting agents: deterministic regression on synthetic placement histories, with shortlist fit and outreach tone scoring before an agent is allowed into a live workflow.'
...
HERO_TITLE = 'Outbound Agent Eval'
